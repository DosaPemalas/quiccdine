...
<!--footer-->
	<div class="footer">
		<div class="container">
			...
			<p class="footer-class animated wow bounce" data-wow-duration="1000ms" data-wow-delay="500ms">&copy;Design by  <a href="http://w3layouts.com/" target="_blank">Kelompok 8</a> </p>
		</div>
	</div>
	<!--//footer-->
</body>
